...
parser.add_argument('--use_hgm_ddi', action='store_true', default=False, help='apply HG model of drugs')

parser.add_argument('--hgmtype', type=int, default=0, help='type of self-defined HGM model')
